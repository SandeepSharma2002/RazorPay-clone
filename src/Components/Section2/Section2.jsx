...
export default function Section2() {
  return (
    <section className="relative w-full px-8 items-center justify-center font-mullish mb-[64px]">
        <img src={Dots} alt="" className="absolute  -top-36 left-40 -z-10" />
        <img src={Dots} alt="" className="absolute  top-12 right-0 rotate-180 -z-10" />
      <div className="flex max-w-[1080px] mx-auto flex-col gap-20">
        <div className="w-full items-center flex flex-col">
          <div className="text-2xl font-mullish font-bold text-#02042A">
        ...
        <div className="px-10 py-12 bg-white flex flex-row relative border rounded-md pb-14">
          <div className="flex flex-col gap-8 max-w-[510px]">
            ...
            <div className="flex gap-3">
              <button className="flex px-5 py-3 text-white bg-lightBlue300 rounded-sm text-lg font-bold hover:bg-lightBlue500 transition-all duration-200 items-center gap-3">
              ...
              <button className="flex px-5 py-3 bg-white text-lightBlue300 rounded-sm text-lg font-bold hover:text-lightBlue500 transition-all duration-200 items-center gap-1">
                <span> Know More</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
          ...
          <img src={paymentsuite} alt="" className="absolute top-0 right-0 max-w-[600px]" />
        </div>
      </div>
    </section>
  );
