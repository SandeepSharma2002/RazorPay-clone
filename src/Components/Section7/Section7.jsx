...
export default function Section7() {
  return (
    <section className="w-full bg-[#f5f8fe] mx-auto px-8 items-center justify-center font-mullish pt-48 -mt-[200px] -z-10">
      <div className="flex max-w-[1080px] mx-auto justify-between items-center flex-col md:flex-row">
        <div className="flex flex-col max-w-[450px] md:py-8 overflow-hidden">
        ...
        <div className="h-[500px] relative overflow-hidden">
          <div
            className="absolute w-full h-40 top-0 z-20"
            style={{ background: "linear-gradient(180deg, #f4f8ff, #fff0)" }}
          ></div>
          <img
            src={merchants}
            alt=""
            className=" relative h-auto w-auto object-cover moveImage delay-0  animate-moveimg"
          />
          <div
            className="absolute w-full h-40 bottom-0 z-20"
            style={{ background: "linear-gradient(360deg, #f4f8ff, #fff0)" }}
          ></div>
        </div>
      </div>
    </section>
